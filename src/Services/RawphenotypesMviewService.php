 ...
 * @ingroup tripal_mviews_api
 */
public static function tripal_edit_mview($mview_id, $name, $modulename, $mv_table, $mv_specs,
 ...
 * @ingroup tripal_mviews_api
 */
public static function tripal_mviews_get_mview_id($view_name) {
 ...
 * @ingroup tripal_core
 */
public static function tripal_mviews_action($op, $mview_id, $redirect = FALSE) {
  global $user;
 ...
 * @ingroup tripal_mviews_api
 */
public static function tripal_update_mview($mview_id) {
  $sql = "SELECT * FROM {tripal_mviews} WHERE mview_id = %d ";
  $mview = db_fetch_object(db_query($sql, $mview_id));
  if ($mview) {
    $previous_db = tripal_db_set_active('chado');  // use chado database
 ...
 * @ingroup tripal_mviews_api
 */
public static function tripal_mview_report($mview_id) {
 ...
 * @ingroup tripal_mviews_api
 */
public static function tripal_mviews_report() {
 ...
 * @ingroup tripal_core
 */
public static function tripal_mviews_form(&$form_state = NULL, $mview_id = NULL) {
 ...
 * @ingroup tripal_core
 */
public static function tripal_mviews_form_validate($form, &$form_state) {
 ...
 * @ingroup tripal_core
 */
public static function tripal_mviews_form_submit($form, &$form_state) {
